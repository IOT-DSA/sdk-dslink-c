...
.globl	fips_aes_encrypt
.type	fips_aes_encrypt,@function
.align	16
fips_aes_encrypt:
	pushq	%rbx
	pushq	%rbp
...
.Lenc_epilogue:
	.byte	0xf3,0xc3
.size	fips_aes_encrypt,.-fips_aes_encrypt
...
.globl	fips_aes_decrypt
.type	fips_aes_decrypt,@function
.align	16
fips_aes_decrypt:
	pushq	%rbx
	pushq	%rbp
...
.Ldec_epilogue:
	.byte	0xf3,0xc3
.size	fips_aes_decrypt,.-fips_aes_decrypt
.globl	fips_aes_set_encrypt_key
.type	fips_aes_set_encrypt_key,@function
.align	16
...
.Lenc_key_epilogue:
	.byte	0xf3,0xc3
.size	fips_aes_set_encrypt_key,.-fips_aes_set_encrypt_key
...
.globl	fips_aes_set_decrypt_key
.type	fips_aes_set_decrypt_key,@function
.align	16
...
.Ldec_key_epilogue:
	.byte	0xf3,0xc3
.size	fips_aes_set_decrypt_key,.-fips_aes_set_decrypt_key
.globl	fips_aes_cbc_encrypt
.type	fips_aes_cbc_encrypt,@function
.align	16
...
.Lcbc_picked_te:
	...
	movl	fips_openssl_ia32cap_p(%rip),%r10d
	cmpq	$512,%rdx
...
.Lcbc_epilogue:
	.byte	0xf3,0xc3
.size	fips_aes_cbc_encrypt,.-fips_aes_cbc_encrypt
.align	64
.LAES_Te:
